...
<nav class="bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200">
	<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
		<a href="http://localhost:5173" class="flex items-center">
			<img src="/img/logo_gp_01.png" class="h-10 mr-3" alt="logo_senior" />
			<span class="self-center text-2xl font-semibold whitespace-nowrap">시니어.닷컴</span>
		</a>
		<div class="flex md:order-2">
			...
			<button
				...
				class="text-white bg-blue-700 ml-3 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0"
				>로그인</button
			>
			<button
